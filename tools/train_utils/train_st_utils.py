...
def train_one_epoch_st(model, optimizer, source_reader, target_loader, model_func, lr_scheduler,
                       ...
                       dataloader_iter, tb_log=None, leave_pbar=False, ema_model=None, alpha = 0.999):
    ...
    for cur_it in range(total_it_each_epoch):
        ...
        for student_model_para, teacher_model_para in zip(model.parameter(), ema_model.parameter()):
            teacher_model_para = student_model_para * alpha + teacher_model_para * (1 - alpha)
    ...
    with tqdm.trange(start_epoch, total_epochs, desc='epochs', dynamic_ncols=True,
        ...
        for cur_epoch in tbar:
            ...
            accumulated_iter = train_one_epoch_st(
                ...
                dataloader_iter=dataloader_iter, ema_model=ema_model, alpha=alpha
            )
